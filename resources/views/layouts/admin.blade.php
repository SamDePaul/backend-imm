                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <figure class="img-profile rounded-circle avatar font-weight-bold"
                                    data-initial="{{ Auth::user()->nama_lengkap[0] }}"></figure>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <<<<<<< Updated upstream <span>Copyright &copy; <a
                                href="https://github.com/SamDePaul/backend-imm" target="_blank">IMM</a>
                            {{ now()->year }}</span>
                            =======
                            <span>Copyright &copy; <a href="https://github.com/SamDePaul"
                                    target="_blank">SamDePaul</a> {{ now()->year }}</span>
                            >>>>>>> Stashed changes
                    </div>
                </div>
            </footer>
